...
export const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-40 flex flex-col justify-center bg-[#1d1d1d]/95 backdrop-blur-xl transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
          isOpen
            ...
            {SITE_CONTENT.stages.map((stage, idx) => {
              ...
              return (
                <button
                  ...
                  className={`group relative flex flex-col items-start rounded-lg border p-5 text-left transition-all duration-300 ${
                    isActive
                ...
                >
                  ...
                  <h3 className="font-serif-italic text-lg tracking-wide text-white group-hover:text-white/90">
                    {stage.name}
                  </h3>
